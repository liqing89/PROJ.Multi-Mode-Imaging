...
def scatter_info(img_roi, mask):
    ...
    return info
def scatter_matrix_to_txt(tiff_path, matrix):
...
class Extractor:
    ...
    def performExtract(self, data_path, meta, target_name):
        ...
        self.roi = img_roi
        # scatter_matrix_to_txt(tiffFilePath, scatter_center)
...
if __name__ == "__main__":
        ...
        tiffFilePath = r"/home/liq/pro/test_for_Production/dataset/FJ/AC130/HH/X/1_1/18_0/18_0.png"
        target_name = 'FJ'
